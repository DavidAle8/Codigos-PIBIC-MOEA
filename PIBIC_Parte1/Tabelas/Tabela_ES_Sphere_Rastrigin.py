...
p_r_pais_filhos = [(0.10, 0.1, 5, 10), (0.50, 1, 15, 100), (1, 100, 25, 250)]
...
#  Valores para pais =  5,      15,  25
#  Valores para filho = 10,    100, 250
...
caminhos_arquivos_sphere = [
    ...
    "/content/drive/MyDrive//Colab Notebooks/Arqs txt/ES_Sphere/1-RS_Sphere_p=0.10_r=0.1_t=1000_i=1000.txt",
...
def prenchendo_configuracoes(iteracao, lista_pr, lista_config):
    ...
    for i in iteracao:
        ...
        for p, r, pais, filhos in lista_pr:
            config = f"iteração = {i} p = {p} r = {r} pais = {pais} filhos = {filhos}"
...
prenchendo_configuracoes(iteracaoes, p_r_pais_filhos, configuracoes)
